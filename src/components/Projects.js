      ...
      <section className='main_projects'>
        ...
        <ul>
          ...
          <li>
            ...
            <p className='project_blurb'>
              Travel planner using React.js, personal project
              for the organisation of an upcoming group trip.
              User will be able to post tips, routes, places,
              and any info they find useful for the trip.
              Will feature a login for users, and a RESTful API
              for data keeping.
            </p>
            <p>- work in progress -</p>
          </li>
          <li>
            ...
            <p className='project_blurb'>
              RESTful API for data keeping of the newest edition
              for the game Warhammer 40.000. Will feature data
              for all characters, weapons, factions and more.
              Data will be given in JSON format, and kept in MySQL.
            </p>
            <p>- work in progress -</p>
          </li>
        </ul>
